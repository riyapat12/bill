    ...
    SearchableOptionList.prototype = {
        ...
        defaults: {
            ...
            texts: {
                ...
                quickDelete: '&times;',
                searchplaceholder: 'Click here to search item...',
        ...
        _initializeUiElements: function () {
            ...
            if (this.config.resultsContainer) {
                ...
                this.$showSelectionContainer.appendTo($('#divSelectedItems'))
        ...
        _addSelectionDisplayItem: function ($changedItem) {
            ...
            if (!$existingDisplayItem) {
                $displayItemText = $('<span class="sol-selected-display-item-text" />').html(solOptionItem.label + "<span class='clsId' style='color:red;display:none;'>" + solOptionItem.value + "</span>");
